...
class STATES:
	...
	class INTENSITY:
		const GROUP : int = 2470328564
	
		class STATE:
			const NONE : int = 748895195
			const HIGH : int = 3550808449
			const LOW : int = 545371365
			const MID : int = 1182670505

	class PHASE:
		const GROUP : int = 3459452222
	
		class STATE:
			const NONE : int = 748895195
			const EVENT : int = 3161415855
			const GAMEPLAY : int = 89505537
			const MENU : int = 2607556080
			const RESULTS : int = 3780578133
			const SPECIAL : int = 3064974266

	class RESULT:
		const GROUP : int = 936499202
	
		class STATE:
			const NONE : int = 748895195
			const LOSE : int = 221232726
			const WIN : int = 979765101


class SWITCHES:

	class SPINNUM:
		const GROUP : int = 2275025563
...
class GAME_PARAMETERS:
	...
	const MASTERVOL : int = 736504446
	const OSTVOL : int = 2349374904
	const SFXVOL : int = 3432874653
	const SPINNUM : int = 2275025563
